...
본문은 "~합니다"체가 아니라 "~하다"체(요약체/개조식)로 씁니다. 예: "저장한다", "~할 수 있다", "~때문이다".

## 문서 본문 구조 (학습 노트 템플릿)

복습에 쓰기 좋도록, 새 문서는 기본적으로 아래 순서의 섹션으로 작성합니다.
...
- **기본 개념**: 한두 문단으로 정의·핵심 요약. 처음 보는 사람도 이해할 수준으로.
- **심화**: 내부 동작 원리, 왜 그렇게 설계됐는지, 관련 개념과의 관계.
- **헷갈리기 쉬운 포인트**: 헷갈리기 쉬운 부분, 자주 나오는 질문/실수, 더 파볼 만한 주제.
- **적용 사례**: 코드 스니펫, 실무/실제 사용 사례.
- 주제 성격에 안 맞으면 섹션 이름을 바꾸거나 생략해도 됩니다 — 강제 규칙이 아니라 기본 골격입니다.
- 긴 줄글보다는 소제목(`###`), 표, 코드블록, 리스트를 적극 활용해 블로그 게시글처럼 짜임새 있게 구성합니다.
